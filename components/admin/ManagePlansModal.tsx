...
import EditPackageModal, { PackageData } from "./EditPackageModal";
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-slate-900/70 backdrop-blur-md animate-in fade-in duration-200">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-4">
          <div>
            <h3 className="text-xl sm:text-2xl font-extrabold text-slate-900 flex items-center gap-2.5">
              <Sliders className="w-6 h-6 text-[#007eff]" /> Pricing Grid & Subscription Plans Manager
            </h3>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-4 py-2.5 rounded-2xl text-xs font-extrabold text-white bg-[#007eff] hover:bg-blue-600 transition-colors cursor-pointer flex items-center gap-1.5 shadow-sm"
            >
              <Plus className="w-4 h-4" /> Add New Plan Card
            </button>
        ...
        {/* Pricing Grids Cards matching PricingCardsGrid */}
              ...
              >
                ...
                <div className="pt-6 mt-6 border-t border-slate-100 flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="p-3.5 rounded-full bg-red-50 hover:bg-red-100 text-red-600 border border-red-200 transition-colors cursor-pointer"
        ...
        <div className="pt-4 border-t border-slate-100 flex justify-end">
          <button
            type="button"
            onClick={onClose}
            className="px-6 py-2.5 rounded-2xl font-extrabold text-xs sm:text-sm text-white bg-slate-900 hover:bg-slate-800 transition-colors cursor-pointer"
          >
            Done Managing Plans
          </button>
        </div>
      ...
      {/* Render Edit Package Portal Modal */}
