          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            <div className="p-3.5 rounded-2xl bg-blue-50/80 border border-blue-200 flex items-center justify-between text-xs">
              ...
              <button
                ...
                className="hidden sm:flex items-center gap-1 text-[#007eff] hover:underline font-extrabold text-xs"
              >
          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-4 border-t lg:border-t-0 lg:border-l border-slate-200 pt-4 lg:pt-0 lg:pl-6">
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div
                  ...
                  className="relative h-24 rounded-2xl bg-white border border-slate-200 cursor-pointer hover:bg-slate-100 flex flex-col items-center justify-center text-slate-500 text-xs font-mono p-2 text-center overflow-hidden transition-colors"
                >
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full py-2.5 rounded-xl bg-white hover:bg-slate-100 border border-slate-200 text-slate-800 font-bold text-xs flex items-center justify-center gap-2 transition-colors"
              >
